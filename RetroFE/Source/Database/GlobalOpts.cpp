...
const global_options::options_entry global_options::s_option_entries[] =
{
    ...
    { OPTION_DUMPPROPERTIES,          "false",     global_options::option_type::BOOLEAN,  "Dump contents of properties to txt in current directory", "Dump Properties on Next Run"},
    ...
    { OPTION_HORIZONTAL,              "stretch",   global_options::option_type::STRING,   "Pixel width INT or STRETCH", "Horizontal Resolution" },
    { OPTION_VERTICAL,                "stretch",   global_options::option_type::STRING,   "Pixel height INT or STRETCH", "Vertical Resolution" },
    ...
    { OPTION_WINDOWBORDER,            "false",     global_options::option_type::BOOLEAN,  "Show window border", "Enable Window Border" },
    { OPTION_WINDOWRESIZE,            "false",     global_options::option_type::BOOLEAN,  "Allow window to be resized", "Enable Window Resizing" },
    ...
    { OPTION_HIDEMOUSE,               "true",      global_options::option_type::BOOLEAN,  "Defines whether the mouse cursor is hidden", "Hide Mouse Cursor" },
    { OPTION_ANIMATEDURINGGAME,       "true",      global_options::option_type::BOOLEAN,  "Pause animated marquees while in the game", "Disable Animations During Game" },
    ...
    { OPTION_VIDEOLOOP,               "0",         global_options::option_type::INTEGER,  "Number of times to play video, 0 forever", "Video Loop Count, 0 Forever" },
    ...
    { OPTION_DISABLEPAUSEONSCROLL,    "false",     global_options::option_type::BOOLEAN,  "Restart video when selected", "Restart Video on Selection" },

    { nullptr,                         nullptr,    global_options::option_type::HEADER,   "RENDERER OPTIONS", "Renderer Options" },
    { OPTION_VSYNC,                    "false",    global_options::option_type::BOOLEAN,  "Vertical synchronization", "Enable V-Sync" },
    { OPTION_HARDWAREVIDEOACCEL,       "false",    global_options::option_type::BOOLEAN,  "Hardware decoding", "Enable Hardware Video Acceleration" },
